...
export default function SearchPage() {
  return (
    <Suspense fallback={<div className="container-x py-16"><ProductGridSkeleton count={8} /></div>}>
      <ShopClient heroId="search" isSearch title="Search" eyebrow="Search" blurb="Search by product, brand, category or keyword." crumbs={[{ label: "Search" }]} showCategoryNav={false} />
    </Suspense>
  );
}
